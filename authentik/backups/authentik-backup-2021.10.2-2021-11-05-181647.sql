...
16	d121d069-97d1-4049-a927-adbe37498efc	14	59	3
\.
...
SELECT pg_catalog.setval('public.authentik_core_user_user_permissions_id_seq', 17, true);
...
SELECT pg_catalog.setval('public.guardian_userobjectpermission_id_seq', 16, true);
